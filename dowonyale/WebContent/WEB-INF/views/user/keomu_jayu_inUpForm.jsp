...
$(function(){
	...
	$("#btn_reg").click(function() {
		...
		if($("#board_id").val() != "" && $("#board_id").val() != null){
			regUrl = "/user/keomu_jayu_update.dowon";
		}
		else{
			regUrl = "/user/keomu_jayu_insert.dowon";
		}
		...
		if(confirm("등록 하시겠습니까?"))
		{
			$("#frm").ajaxSubmit({
				...
				success: function(result){
					alert("등록 되었습니다.");
					$(location).attr('href', '/user/keomu_jayu.dowon');
				},
...
<div class="wrap">
	<!--	container	-->
	<div class="container">
		<jsp:include page="/common/header.dowon" ><jsp:param name="depth1" value="5" /><jsp:param name="depth2" value="4" /></jsp:include>
		...
		<div class="contents"> 
			...
			<!--	navi	-->
			<div class="navi">
				<span class="navigator">Home &gt; 커뮤니티 &gt; <span class="navi_menu2">자유게시판</span></span>
			</div>  
			<!--	//navi	-->     
			<!--	cont	-->
			<div class="cont">
				<jsp:include page="/common/left.dowon"><jsp:param name="depth1" value="5" /><jsp:param name="depth2" value="4" /></jsp:include>

				<!--	con_body	-->
				<div class="con_body">
					<form id="frm" name="frm" method="post" action="">
						<c:set var="default_url" value="/user/keomu_jayu.dowon"></c:set>
						<input type="hidden" name="board_id" id="board_id" value="<c:out value='${result.board_id }' />"/>
						<img src="/images/sub/02_content_05_04.png" alt="자유게시판"/>
						<div id="keomu_jayu">
					        <table cellspacing="0" cellpadding="3">
					        	...
					        	<tr>
					        		<td colspan="2">
					        			<textarea name="board_txt" id="board_txt" rows="8" cols="70" style="width:765px;">${result.board_txt }</textarea>
					        		</td>
					        	</tr>
					        </table>
