...
<div class="wrap">
	<!--	container	-->
	<div class="container">
		<jsp:include page="/common/header.dowon" ><jsp:param name="depth1" value="1" /><jsp:param name="depth2" value="2" /></jsp:include>
		...
		<div class="contents"> 
			...
			<!--	navi	-->
			<div class="navi">
				<span class="navigator">Home &gt; 도원예일소개 &gt; <span class="navi_menu2">원장인삿말</span></span>
			</div>  
			<!--	//navi	-->     
			<!--	cont	-->
			<div class="cont">
				<jsp:include page="/common/left.dowon"><jsp:param name="depth1" value="1" /><jsp:param name="depth2" value="2" /></jsp:include>

				<!--	con_body	-->
				<div class="con_body">
					<div id="intro_intro_wonjang"></div>
				</div>
				<!--	con_body	-->            
			</div>
			<!--	//cont	-->        
