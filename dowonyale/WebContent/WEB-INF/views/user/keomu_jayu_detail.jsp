...
$(function(){
	//수정
	$(".goUpForm").bind("click",function(){
		$("form[name=frm]").attr("action","/user/keomu_jayu_inUpForm.dowon");
	...
	$(".goDelete").click(function() {
		...
		{
			$("#frm").ajaxSubmit({
				url : "/user/keomu_jayu_delete.dowon",
				type : "post",
				dataType: "json",
	...
	$(".goPre").bind("click",function(){
		...
		$("form[name=frm]").attr("action","/user/keomu_jayu_detail.dowon");
		$("form[name=frm]").submit();
	});
