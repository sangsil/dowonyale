...
<div class="wrap">
	<!--	container	-->
	<div class="container">
		<jsp:include page="/common/header.dowon" ><jsp:param name="depth1" value="5" /><jsp:param name="depth2" value="5" /></jsp:include>
		...
		<div class="contents"> 
			...
			<!--	navi	-->
			<div class="navi">
				<span class="navigator">Home &gt; 커뮤니티 &gt; <span class="navi_menu2">관련사이트</span></span>
			</div>  
			<!--	//navi	-->     
			<!--	cont	-->
			<div class="cont">
				<jsp:include page="/common/left.dowon"><jsp:param name="depth1" value="5" /><jsp:param name="depth2" value="5" /></jsp:include>

				<!--	con_body	-->
				<div class="con_body">
					<div id="keomu_gwanryeon"></div>
				</div>
				<!--	con_body	-->            
