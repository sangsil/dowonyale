...
<div class="wrap">
	<!--	container	-->
	<div class="container">
		<jsp:include page="/common/header.dowon" ><jsp:param name="depth1" value="2" /><jsp:param name="depth2" value="4" /></jsp:include>
		...
		<div class="contents"> 
			...
			<!--	navi	-->
			<div class="navi">
				<span class="navigator">Home &gt; 치료프로그램 &gt; <span class="navi_menu2">그룹치료</span></span>
			</div>  
			<!--	//navi	-->     
			<!--	cont	-->
			<div class="cont">
				<jsp:include page="/common/left.dowon"><jsp:param name="depth1" value="2" /><jsp:param name="depth2" value="4" /></jsp:include>

				<!--	con_body	-->
				<div class="con_body">
					<div id="chiryo_geurup"></div>
				</div>
				<!--	con_body	-->            
			</div>
			<!--	//cont	-->        
