...
<script>
	...
	/*	등록	*/
		$("#btn_reg").click(function(e) {
			...
			if($("#board_id").val() != "" && $("#board_id").val() != null){
				regUrl = "/admin/gyoukUpdate.dowon";
			}
			else{
				regUrl = "/admin/gyoukInsert.dowon";
			}
	...
	/*	//등록	*/
		...
		$("#btn_del").bind("click",function(){
			...
			{
				$("#frm").ajaxSubmit({
					url : "/admin/gyoukDelete.dowon?arr_board_id="+$("#board_id").val(),
					type : "post",
					dataType: "json",
					success: function(result){
						alert("삭제 되었습니다.");
...
<div class="contents">
	...
	<form id="frm" name="frm" method="post" action="">
		...
		<!-- con3 -->
	    <div class="con3">
	        <table class="modalTable_gyouk" border="1" cellspacing="0" cellpadding="3">
				<tr>
