...
<script>
	...
	/*	등록	*/
		$("#btn_reg").click(function(e) {
			...
			if($("#board_id").val() != "" && $("#board_id").val() != null){
				regUrl = "/admin/onlineUpdate.dowon";
			}
			else{
				regUrl = "/admin/onlineInsert.dowon";
			}
			if(confirm("등록 하시겠습니까?"))
			{
				$("#frm").ajaxSubmit({
					...
					success: function(result){
						alert("등록 되었습니다.");
						$("form[name=frm]").attr("action","/admin/onlineList.dowon");
	...
	/*	//등록	*/
		...
		$("#btn_del").bind("click",function(){
			...
			{
				$("#frm").ajaxSubmit({
					url : "/admin/onlineDelete.dowon?arr_board_id="+$("#board_id").val(),
					type : "post",
					dataType: "json",
					success: function(result){
						alert("삭제 되었습니다.");
...
<div class="contents">
	...
	<form id="frm" name="frm" method="post" action="">
		...
		<!-- con3 -->
	    <div class="con3">
	        <table class="modalTable_online" border="1" cellspacing="0" cellpadding="3">
				<tr>
				...
				<tr>
					<td>내용</td>
					<td>
						<textarea name="board_txt" id="board_txt" rows="8" cols="70" style="width:820px;">
							<p>============================================ 답변 내용(${sessionScope.USER_NAME}) ============================================</p><p>&nbsp;</p><p>============================================ 문의 내용 ============================================</p>
							${result.board_txt }
						</textarea>
					</td>
				</tr>
