...
<script>
	...
	/*	등록	*/
		$("#btn_reg").click(function(e) {
			...
			if($("#board_id").val() != "" && $("#board_id").val() != null){
				regUrl = "/admin/jayuUpdate.dowon";
			}
			else{
				regUrl = "/admin/jayuInsert.dowon";
			}
			if(confirm("등록 하시겠습니까?"))
			{
				$("#frm").ajaxSubmit({
					...
					success: function(result){
						alert("등록 되었습니다.");
						$("form[name=frm]").attr("action","/admin/jayuList.dowon");
	...
	/*	//등록	*/
		...
		$("#btn_del").bind("click",function(){
			...
			{
				$("#frm").ajaxSubmit({
					url : "/admin/jayuDelete.dowon?arr_board_id="+$("#board_id").val(),
					type : "post",
					dataType: "json",
					success: function(result){
						alert("삭제 되었습니다.");
...
<div class="contents">
	...
	<form id="frm" name="frm" method="post" action="">
		...
		<!-- con3 -->
	    <div class="con3">
	        <table class="modalTable_jayu" border="1" cellspacing="0" cellpadding="3">
				<tr>
